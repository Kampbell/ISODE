...
class Sender {
public:
	virtual int  operator()(int cc = 0, const void* data = nullptr) = 0;
};
class Receiver {
public:
	virtual int  operator()(int cc = 0, void* data = nullptr) = 0;
};
...
public:
	...
	virtual int  operator()(int cc = 0, const void* data = nullptr) {
...
public:
	...
	virtual int  operator()(int cc = 0, void* data = nullptr) {
