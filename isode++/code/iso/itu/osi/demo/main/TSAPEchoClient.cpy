	...
	void defineOptions(OptionSet& options)
	{
		...
		options.addOption(
			Option("help", "h", "display help information on command line arguments")
				.required(false)
				.repeatable(false)
				.callback(OptionCallback<TSAPEchoApp>(this, &TSAPEchoApp::handleHelp)));
		...
		options.addOption(
			Option("username", "u", "specify the Twitter user/account name")
				...
				.repeatable(false)
				.argument("account")
				.callback(OptionCallback<TSAPEchoApp>(this, &TSAPEchoApp::handleUsername)));
		...
		options.addOption(
			Option("password", "p", "specify the Twitter password")
				...
				.repeatable(false)
				.argument("password")
				.callback(OptionCallback<TSAPEchoApp>(this, &TSAPEchoApp::handlePassword)));
		...
		options.addOption(
			Option("message", "m", "specify the status message")
				...
				.repeatable(true)
				.argument("message")
				.callback(OptionCallback<TSAPEchoApp>(this, &TSAPEchoApp::handleMessage)));
	}
...
//			_twitter.login(_username, _password);
			Poco::Int64 statusId = 0;//_twitter.update(value);
