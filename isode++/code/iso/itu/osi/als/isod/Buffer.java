...
public abstract class NetworkBuffer {
     ...
     */
    public final NetworkBuffer position(int newPosition) {
     ...
     */
    public final NetworkBuffer limit(int newLimit) {
     ...
     * @return  This buffer
     */
    public final NetworkBuffer mark() {
        mark = position;
        return this;
    }
     ...
     */
    public final NetworkBuffer reset() {
        int m = mark;
        if (m < 0)
     ...
     * @return  This buffer
     */
    public final NetworkBuffer flip() {
        limit = position;
        position = 0;
        mark = -1;
        return this;
     ...
     * @return  This buffer
     */
    public final NetworkBuffer rewind() {
        position = 0;
        mark = -1;
        return this;
    }
     ...
     * <a href="ByteNetworkBuffer.html#direct"><i>direct</i></a>. </p>
     *
